        ...
        <div className="footer__content grid text__light text__center">
          <div className="footer__content--item">
            <p className="para__text">
              &copy; 2023 All rights reserved. Designed by Mahmoud Nabil.
            </p>
          </div>

          <div className="footer__content--item">
            <a href="mailto:e.mahmoudnabil@gmail.com">
              e.mahmoudnabil@gmail.com
            </a>
            <br />
            <span>+201146285867</span>
          </div>
          ...
          <div class="footer__content--item" id="back-top">
            <p class="pull-right">
              <a href="#home">
                <span></span> Top
              </a>
